...
{
    #[Route('/', name: 'app_planningcoach_index', methods: ['GET'])]
    public function index(EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('planningcoach/index.html.twig', [
            'plannings' => $plannings,
        ]);
    }

    #[Route('/new', name: 'app_planningcoach_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_planningcoach_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('planningcoach/new.html.twig', [
            'planning' => $planning,
            'form' => $form,
        ]);
    }
    #[Route('/planningcoach/{id}', name: 'app_planningcoach_show', methods: ['GET'])]
    ...
    return $this->render('planningcoach/show.html.twig', [
        'planning' => $planning,
    ...
    #[Route('/{idplanning}/edit', name: 'app_planningcoach_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Planning $planning, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('planningcoach/edit.html.twig', [
            'planning' => $planning,
            'form' => $form,
        ]);
    }

    #[Route('/{idplanning}', name: 'app_planningcoach_delete', methods: ['POST'])]
...
#[Route('/search', name: 'app_planningcoach_search')]
public function search(Request $request): Response
{
    ...
    return $this->render('planningcoach/search.html.twig', [
        'planning' => $planning,
        'base64Image' => $base64Image,
    ]);
...
#[Route('/statscoach', name: 'app_statscoach', methods: ['GET'])]
public function stats(EntityManagerInterface $entityManager): Response
{
  ...
  return $this->render('planningcoach/stat.html.twig', [
